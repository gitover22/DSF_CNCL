...
{
    CNCL_CHECK(cnclSend(dev_list[2].get_send_buffer(), dev_list[2].send_buffer_size/INT_COUNT, cnclInt32, comm_list[7].get_rank(),
                        comm_list[2].getCnclComm(), dev_list[2].get_queue()));
    CNCL_CHECK(cnclRecv(dev_list[7].get_recv_buffer(), dev_list[2].send_buffer_size/INT_COUNT, cnclInt32, comm_list[2].get_rank(),
